...
class DataValidation:
    def __init__(self, data_ingestion_artifact: DataIngestionArtifact, data_validation_config: DataValidationConfig):
        """
        :Param datain_ingestion_artifact: Output refrence of data artifact stage
    ...
    def is_column_exist(self, df: DataFrame) -> bool:
        ...
        """
        try:
            dataframae_columns = df.columns
            missing_numerical_columns = []
            missing_categorical_columns = []
            for column in self._schema_config["numerical_columns"]:
                if column not in dataframae_columns:
            ...
            for column in self._schema_config["categorical_columns"]:
                ...
                if len(missing_categorical_columns) > 0:
                    logging.ingo(f"Missing categorical column: {missing_categorical_columns}")
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        ...
        try:
            ...
            ## Validating col dtypessfor train/test df
